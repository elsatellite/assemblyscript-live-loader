#### Fork of [dongsik-yoo/assemblyscript-live-loader](https://github.com/dongsik-yoo/assemblyscript-live-loader)

Updated `assemblyscript` version: `"assemblyscript": "^0.9.4"`

## Installation

```
npm install --save-dev npm install github:elsatellite/assemblyscript-live-loader
```
...
Supports fallback javascript module which is transpiled by typescript compiler.
...
```js
var buffer = new ArrayBuffer(1163);
